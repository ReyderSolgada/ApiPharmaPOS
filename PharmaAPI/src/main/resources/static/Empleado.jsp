<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <jsp:include page="WEB-INF/head.jsp">
    	<jsp:param  name="title" value="Empleado"/>
    </jsp:include>
              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                    ...
                    <input type="button" name="" value="Nuevo" class="btn btn-primary" data-toggle="modal" data-target="#fm-modal-add-emp" style="margin-left: 20px;" onclick="cargarCombos('#id-add-cmbdistrito','#id-add-cmbcargo')">
                  </div>                
                                    
                  <div class="table-responsive">
                    <table class="table card-table table-vcenter text-nowrap" id="tblempleados">
                      <thead>
                        <tr>
                          <th class="w-1">Cod.Emp</th>
                          <th>Nombres y Apellidos</th>                          
                          <th>Fecha Contract.</th>
                          <th>RUC/DNI</th>
                          <th>Sexo</th>
                          <th>Teléfono</th>
                          <th>Dirección</th>
                    ...
                    <jsp:include page="agregarEmpleado.jsp"></jsp:include>
                    <jsp:include page="editarEmpleado.jsp"></jsp:include>
