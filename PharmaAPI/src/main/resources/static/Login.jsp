...
<title>Login - tabler.github.io - a responsive, flat and full
			...
			<div class="container">
				<div class="row">
					<div class="col col-login mx-auto">
						...
						<form class="card" action="Empleado.jsp" method="post">
							<div class="card-body p-6">
								...
								<div class="form-group">
									<label class="form-label" id="password"> Contraseña <a
								...
								<div class="form-group">
									<label class="custom-control custom-checkbox"> <input
										...
										class="custom-control-label">Recordar</span>
									</label>
								</div>
