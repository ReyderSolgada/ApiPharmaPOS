...
public class SupplierController {
	...
	@RequestMapping(value = "/suppliers/{id}", method = RequestMethod.GET, headers = "Accept=application/json")
	...
	@RequestMapping(value = "/suppliers", method = RequestMethod.POST, headers = "Accept=application/json")
